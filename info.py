...
URL = "https://rs-yeoc.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://rs-yeoc.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://rs-yeoc.onrender.com/".format(FQDN)
else:
    URL = "https://rs-yeoc.onrender.com/".format(FQDN)
https
